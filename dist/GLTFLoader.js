            ...
            for (var i = 0, il = targets.length; i < il; i++) {
                ...
                if (hasMorphPosition) {
                    ...
                    if (target.POSITION !== undefined) {
                        ...
                        for (
                            var j = 0, jl = positionAttribute.count; j < jl; j++
                        ) {
                ...
                if (hasMorphNormal) {
                    ...
                    if (target.NORMAL !== undefined) {
                        ...
                        for (
                            var j = 0, jl = normalAttribute.count; j < jl; j++
                        ) {
        ...
        return Promise.all(pending).then(function(geometries) {
            if (isMultiPass) {
                ...
                return Promise.all(pendingIndices).then(function(accessors) {
                    ...
                    for (
                        var i = 0, il = originalPrimitives.length; i < il; i++
                    ) {
                ...
                return parser
                    ...
                    .then(function(mesh) {
                        ...
                        if (meshReferences[nodeDef.mesh] > 1) {
                            ...
                            for (
                                var i = 0, il = node.children.length; i < il; i++
                            ) {
                        ...
                        if (nodeDef.weights !== undefined) {
                            node.traverse(function(o) {
                                ...
                                for (
                                    var i = 0, il = nodeDef.weights.length; i < il; i++
                                ) {
                ...
                .then(function(node) {
                    ...
                    return parser
                        ...
                        .then(function(skin) {
                            ...
                            for (
                                var i = 0, il = skinEntry.joints.length; i < il; i++
                            ) {
                                pendingJoints.push(
                                    parser.getDependency(
                                        "node",
                        ...
                        .then(function(jointNodes) {
                            ...
                            for (var i = 0, il = meshes.length; i < il; i++) {
                                ...
                                for (
                                    var j = 0, jl = jointNodes.length; j < jl; j++
                                ) {
